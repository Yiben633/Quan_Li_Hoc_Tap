...
export function StudyGroupsPage() {
  ...
  return <div className="groups-page">
    ...
    {!groups.isLoading && !groups.isError && !groups.data?.length && <EmptyState icon={<Users size={24} />} title="Chưa có nhóm chia sẻ" description="Tạo một nhóm riêng tư rồi mời những người bạn muốn phối hợp." action={<Button onClick={() => setEditorOpen(true)}><Plus size={16} /> Tạo nhóm đầu tiên</Button>} />}
