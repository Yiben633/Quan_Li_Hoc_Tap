...
export function StudyPlansPage() {
  ...
  const [editing, setEditingState] = useState<StudyPlan | null>(null)
  ...
  const setEditing = (plan: StudyPlan | null) => {
    setEditingState(plan)
    if (plan === null && modalOpen) setModalOpen(false)
  }
