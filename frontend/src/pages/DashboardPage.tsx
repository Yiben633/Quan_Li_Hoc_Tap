...
function DashboardHero({ firstName, streak }: { firstName: string; streak: number | null | undefined }) {
  ...
  return <section className="dashboard-hero">
    ...
    {showScene && <div className="dashboard-hero-scene" aria-hidden="true">
      <img className="dashboard-hero-cloud nature-cloud--drift" src={natureAssets.effects.cloud01} alt="" width={256} height={128} />
      {useFullHeroScene && <><span className="dashboard-hero-leaf dashboard-hero-leaf-one nature-leaf--drift" /><span className="dashboard-hero-leaf dashboard-hero-leaf-two nature-leaf--drift" /></>}
      ...
      <NatureFlora name="bush" width={543} height={724} className="dashboard-hero-bush dashboard-hero-bush-front nature-bush--sway" />
    </div>}
  </section>
}
