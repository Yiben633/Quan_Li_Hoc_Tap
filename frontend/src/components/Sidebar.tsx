...
import { BookOpen, CalendarDays, CheckSquare, LayoutDashboard, Settings, Timer, Users, X } from 'lucide-react'
import { Logo } from './Logo'

const links = [{ to: '/', label: 'Tổng quan', icon: LayoutDashboard }, { to: '/tasks', label: 'Công việc', icon: CheckSquare }, { to: '/calendar', label: 'Lịch học', icon: CalendarDays }, { to: '/subjects', label: 'Không gian học', icon: BookOpen }, { to: '/study', label: 'Tập trung', icon: Timer }]
