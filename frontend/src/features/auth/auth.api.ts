...
export async function register(input: RegisterValues) { const response = await apiClient.post<ApiResponse<AuthUser>>('/auth/register', { ...input, confirmPassword: undefined }); return response.data.data }
