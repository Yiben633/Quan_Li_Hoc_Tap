...
export async function list(req: Request, res: Response) { try { return sendSuccess(res, 'Goals fetched', await service.list(req.user!.id, res.locals.validatedQuery?.status)); } catch (e) { return handle(res, e); } }
