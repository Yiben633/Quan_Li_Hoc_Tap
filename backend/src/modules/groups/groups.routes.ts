...
groupsRouter.get('/', asyncHandler(c.list)); groupsRouter.get('/invitations', asyncHandler(c.invitations)); groupsRouter.post('/', validateBody(groupSchema), asyncHandler(c.create)); groupsRouter.get('/:id/progress', asyncHandler(c.progress)); groupsRouter.get('/:id', asyncHandler(c.detail)); groupsRouter.patch('/:id', validateBody(groupSchema.partial()), asyncHandler(c.update)); groupsRouter.delete('/:id', asyncHandler(c.remove)); groupsRouter.post('/:id/members', validateBody(memberSchema), asyncHandler(c.invite)); groupsRouter.post('/:id/members/:memberId/accept', asyncHandler(c.accept)); groupsRouter.post('/:id/members/:memberId/reject', asyncHandler(c.reject)); groupsRouter.post('/:id/tasks', validateBody(groupTaskSchema), asyncHandler(c.createTask)); groupsRouter.patch('/:id/tasks/:taskId', validateBody(groupTaskUpdateSchema), asyncHandler(c.updateTask));
