...
export async function updateUser(req: Request, res: Response) { try { return sendSuccess(res, 'User updated', await s.updateUser(req.user!.id, p(req, 'id'), req.body)); } catch (e) { return h(res, e); } }
